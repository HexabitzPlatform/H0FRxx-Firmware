...
**H0FR60 is a compact solid state relay (SSR) module capable of driving AC loads up to 600V and 1.2A.** It is based on Panasonic AQH3213A SSR and STM32F0 MCU. It is part of Hexabitz modular prototyping system.

Module web page: https://hexabitz.com/product/600v-1-2a-solid-state-relay-h0fr60/
